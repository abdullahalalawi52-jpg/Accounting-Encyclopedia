    ...
    <div className="container py-12 animate-fade-in min-h-[70vh]">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-[var(--text-secondary)]">
          {isEn ? 'Search any financial transaction to view its accurate double-entry journal record.' : 'ابحث عن أي معاملة مالية (مثال: "شراء بضاعة") ليظهر لك القيد المحاسبي الصحيح.'}
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto mb-12 relative">
        ...
        <input 
          ...
          className="w-full bg-[var(--bg-card)] border-2 border-[var(--border-color)] rounded-full py-4 ps-14 pe-6 text-lg focus:outline-none focus:border-[var(--primary-accent)] text-[var(--text-primary)] shadow-lg"
          value={searchTerm}
